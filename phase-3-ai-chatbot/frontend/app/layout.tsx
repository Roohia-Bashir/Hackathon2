    ...
    <html lang="en">
      <body className={inter.className}>
        <div className="min-h-screen bg-gray-50">
          ...
          {/* Footer */}
          <footer className="relative mt-auto bg-gradient-to-br from-blue-700 via-blue-600 to-gray-800">
            {/* Decorative blur blobs */}
            <div className="absolute inset-0 overflow-hidden">
              <div className="absolute -top-24 -right-24 w-72 h-72 bg-blue-400 rounded-full blur-3xl opacity-25" />
              <div className="absolute -bottom-24 -left-24 w-72 h-72 bg-gray-500 rounded-full blur-3xl opacity-25" />
            </div>
